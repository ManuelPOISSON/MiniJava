...
| LMJ.IIfNoElse (c, i1) -> MJ.IIfNoElse (translate_expression c, translate_instruction i1)
| LMJ.IWhile (c, i) -> MJ.IWhile (translate_expression c, translate_instruction i)
| LMJ.IFor (id1, e1, c, id2, e2, loop) -> MJ.IFor (Location.content id1, translate_expression e1, translate_expression c, Location.content id2, translate_expression e2, translate_instruction loop)
